...
export const story =
  "Poznaliśmy się w Umeå i zakochaliśmy się w noc największej zorzy polarnej, jaką kiedykolwiek widzieliśmy. 7 lat później 3 kraje i 2 kultury — polska i orija — po raz pierwszy łączą się w oficjalnej ceremonii.";
